            ...
            switch (tipoMult) {
                case 1:// Mono * Mono
                    if (numMuestrasAudio1 <= numMuestrasAudio2) {
                        ...
                        fwrite(multiplicacion(muestras2, muestras1, numMuestrasAudio2, numMuestrasAudio1),
                        ...
                        fwrite(multiplicacion(muestras1, muestras2, numMuestrasAudio1, numMuestrasAudio2),
                ...
                case 2://Mono * Stereo
                    if (numMuestrasAudio1 < (numMuestrasAudio2 / 2)) {
                        ...
                        fwrite(&CW2, 44, 1, archivoWavSalida);
                        numMuestrasAudio2 /= 2;
                        short *canal1 = multiplicacion(getAudioSamples16bisCanal1(archivo2), muestras1,
                                                       numMuestrasAudio2, numMuestrasAudio1);
                        short *canal2 = multiplicacion(getAudioSamples16bisCanal2(archivo2), muestras1,
                                                       numMuestrasAudio2, numMuestrasAudio1);
                        fwrite(getSalidaStereo(canal1, canal2, numMuestrasAudio2), getNumberBytesAudioInformation(CW2),
                               1, archivoWavSalida);
                        char *pie = getFileFoot(archivo1);
                        fwrite(pie, getNumberBytesFoot(CW2), 1, archivoWavSalida);
                        ...
                        short *canal1 = multiplicacion(muestras1, getAudioSamples16bisCanal1(archivo2),
                                                       numMuestrasAudio1, numMuestrasAudio2);
                        short *canal2 = multiplicacion(getAudioSamples16bits(archivo1),
                                                       getAudioSamples16bisCanal2(archivo2), numMuestrasAudio1,
                                                       numMuestrasAudio2);
                        fwrite(getSalidaStereo(canal1, canal2, numMuestrasAudio1), getNumberBytesAudioInformation(CW1),
                               1, archivoWavSalida);
                        char *pie = getFileFoot(archivo2);
                        fwrite(pie, getNumberBytesFoot(CW2), 1, archivoWavSalida);
                    }
